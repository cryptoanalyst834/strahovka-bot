...
bot.on('text', async ctx => {
  ...
  let systemPrompt = `
Ты — виртуальный sales-ассистент Straxovka-Go, эксперт по страхованию с навыками маркетолога более 5 лет. Отвечаешь по теме страхования. Поддерживаешь диалог, помнишь диалог с ведешь к продаже.
