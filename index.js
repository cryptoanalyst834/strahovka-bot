...
const outsideTriggers = ["КАСКО ПО РИСКАМ","ТОТАЛ","УГОН","ДМС","СТРАХОВАНИЕ БИЗНЕСА","КАСКО по рискам","УЩЕРБ/ТОТАЛ/УГОН","УГОН/ТОТАЛ","подходит для банка","ДОБРОВОЛЬНОЕ МЕДИЦИНСКОЕ СТРАХОВАНИЕ"];
const outsideResp = `
